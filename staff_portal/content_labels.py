...
CONTENT_SECTIONS = [
    ...
    (
        ...
        [
            ...
            ('ui-about-impact-weekly-value', 'Weekly impact stat'),
            ('ui-about-impact-mobile-value', 'Mobile impact stat'),
    ...
    (
        ...
        [
            ...
            ('ui-contact-info-heading', 'Contact information card heading'),
            ('ui-contact-form-title', 'Contact form heading'),
            ('ui-contact-send-message', 'Send message button'),
            ('ui-contact-volunteer-title', 'Volunteer section heading'),
            ('ui-contact-volunteer-lead', 'Volunteer section intro'),
            ('ui-contact-volunteer-food-title', 'Food service volunteer role'),
            ('ui-contact-volunteer-food-desc', 'Food service volunteer description'),
            ('ui-contact-volunteer-donate-title', 'Donation sorting volunteer role'),
            ('ui-contact-volunteer-donate-desc', 'Donation sorting volunteer description'),
            ('ui-contact-volunteer-event-title', 'Event support volunteer role'),
            ('ui-contact-volunteer-event-desc', 'Event support volunteer description'),
            ('ui-contact-volunteer-cta', 'Volunteer call to action'),
            ('ui-contact-volunteer-note', 'Volunteer orientation note'),
    ...
    (
        ...
        [
            ...
            ('ui-donate-volunteer-body', 'Volunteer card description'),
            ('ui-donate-items-title', 'Donate items card title'),
            ('ui-donate-items-body', 'Donate items card description'),
        ],
    ),
    (
        'site',
